...
# bind login table vars
   ...
   foreach $mem (sort keys %addrtab) {
	 ...
	 $email .= substr($mail, 15, $size);
      ...
      $moreurl = adjusturl("execdogeneric.jsp?pnum=3&p0=$execshowpersonaldir&p1=biscuit&p2=ulogin&p3=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&ulogin=$mem&jp=$jp&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");
   ...
   $folder = adjusturl($folder);
      ...
      $prb = strapp $prb, "template=$ENV{HDTMPL}/personaldir.html";
