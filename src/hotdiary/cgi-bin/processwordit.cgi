...
$prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/cardprocess-$$.html";

parseIt $prml;

#system "/bin/cat $ENV{HDTMPL}/content.html\n\n";
#system "/bin/cat $ENV{HDHREP}/$alphaindex/$login/cardprocess.html";
hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/cardprocess-$$.html";
