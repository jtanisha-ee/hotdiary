...
$diary = $ENV{DIARY};
   ...
   #print &PrintHeader;
   #print &HtmlTop ("businessdir.cgi ");
   hddebug ("businessdir.cgi ");
...
# bind login table vars
   ...
   hddebug "came here in the emptab cntr = $cntr";  
   foreach $mem (sort keys %peopletab) {
      ...
      $pageurl = adjusturl("execdogeneric.cgi?pnum=9&p0=$execshowbusinesspage&p1=biscuit&p2=thispage&p3=to&p4=pt&p5=uname&p6=business&p7=dirtype&p8=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&thispage=$thispage&to=$dbpager&pt=$dbpagertype&uname=$uname&business=$business&dirtype=businessdir&jp=$jp&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");
      ...
      $faxurl = adjusturl("execdogeneric.cgi?pnum=8&p0=$execshowbusinessfax&p1=biscuit&p2=thispage&p3=to&p4=uname&p5=business&p6=dirtype&p7=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&thispage=$thispage&to=$dbfax&uname=$uname&business=$business&dirtype=businessdir&jp=$jp&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6"); 
      ...
      #   $execshowbusinessother = encurl "execshowbusinessother.cgi";
      #}
      #$moreurl = adjusturl("execdogeneric.cgi?pnum=5&p0=$execshowbusinessother&p1=biscuit&p2=business&p3=ulogin&p4=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&ulogin=$mem&jp=$jp&business=$business&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");
   ...
   hddebug "came here in the emptab cntr = $cntr";  
   if ($cntr == 0) {
      status ("$login: You currently do not have any contacts in the Members directory. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=4&p0=$execshowcontactlist&p1=biscuit&p2=businesslist&p3=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&jp=$jp&businesslist=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to return to business directory. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=$execinvitationbusiness&p1=biscuit&p2=businesslist&p3=jp&pnum=4&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&businesslist=$business&jp=$jp&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to invite."); 
      exit;
   }
   ...
   foreach $cn (@hshcdir) {
      ...
      if ($os ne "nt") {
         ...
         $execgetcontactlist = encurl "execgetcontactlist.cgi";
         $execproxylogout = encurl "/proxy/execproxylogout.cgi";
         $execdeploypage =  encurl "execdeploypage.cgi";
         $execshowtopcal =  encurl "execshowtopcal.cgi";
      } else {
         $prb = strapp $prb, "formenc=";
         $execgetcontactlist = "execgetcontactlist.cgi";
         $execproxylogout =  "/proxy/execproxylogout.cgi";
         $execdeploypage =  "execdeploypage.cgi";
         $execshowtopcal =  "execshowtopcal.cgi";
      }
      $prb = strapp $prb, "template=$ENV{HDTMPL}/businessdir.html";
      $prb = strapp $prb, "templateout=$ENV{HDHREP}/$login/businessdir-$$.html";
      ...
      $hiddenvars = "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execgetcontactlist\">";
      ...
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p6 VALUE=invite>";
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p7 VALUE=inviteall>";
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p8 VALUE=done>";
	 ...
	 $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=box$k VALUE=$cn>";
      ...
      #system "cat $ENV{HDHREP}/$login/businessdir.html";
      hdsystemcat "$ENV{HDHREP}/$login/businessdir-$$.html";
