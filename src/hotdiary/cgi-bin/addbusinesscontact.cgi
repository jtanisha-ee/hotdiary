...
#
# FileName: addbusinesscontact.cgi 
...
# bind login table vars
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/addbusinesscontact.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alph/$login/addbusinesscontact-$$.html";
   ...
   $hiddenvars = "<INPUT TYPE=HIDDEN NAME=pnum VALUE=25>";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p22 VALUE=contacttype>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p23 VALUE=newentry>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p24 VALUE=title>";
   ...
   #system "/bin/cat $ENV{HDHREP}/$alph/$login/addbusinesscontact.html"; 
   hdsystemcat "$ENV{HDHREP}/$alph/$login/addbusinesscontact-$$.html"; 
