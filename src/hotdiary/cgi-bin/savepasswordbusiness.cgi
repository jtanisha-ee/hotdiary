...
#
# FileName: savepasswordbusiness.cgi
...
#session timeout in secs
   ...
   hddebug("savepasswordbusiness.cgi");
...
# bind login table vars
   ...
   if ($oldpassword ne $businesstab{$business}{password}) {
      status("$login: Old Password ($oldpassword) does not match with the business ($business) existing password. Please re-enter the password.");
      exit;
   }
   ...
   system "cat $ENV{HDHREP}/$alphaindex/$login/accesscontrolbusiness.html";
