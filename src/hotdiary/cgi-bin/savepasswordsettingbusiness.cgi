...
#
# FileName: savepasswordsettingbusiness.cgi
...
#session timeout in secs
   ...
   hddebug("savepasswordsettingbusiness.cgi");
...
# bind login table vars
   ...
   tie %businesstab, 'AsciiDB::TagFile',
    ...
    SUFIX => '.rec',
    SCHEMA => {
    ORDER => ['business', 'businessmaster', 'password', 'businesstitle', 'street', 'suite', 'city', 'state', 'zipcode', 'country', 'phone', 'fax', 'other', 'list'] };
   ...
   if ($input{'pbusinessmaster'} eq "on") {
      $mgraccesstab{access}{'pbusinessmaster'} = "CHECKED";
   }  else {
      $mgraccesstab{access}{'pbusinessmaster'} = $input{'pbusinessmaster'};
   }

   if ($input{'pbusinessmanager'} eq "on") {
      $mgraccesstab{access}{'pbusinessmanager'} = "CHECKED";
   }  else {
      $mgraccesstab{access}{'pbusinessmanager'} = $input{'pbusinessmanager'};
   }

   if ($input{'pother'} eq "on") {
      $mgraccesstab{access}{'pother'} = "CHECKED";
   }  else {
      $mgraccesstab{access}{'pother'} = $input{'pother'};
   }
