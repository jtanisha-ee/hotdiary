...
# bind login table vars
   ...
   hddebug ("resname in modify resource = $resname");
   if ($resname eq "") {
      if ($os ne "nt") {
      ...
      status("$login: You have not selected a resource to modify. Please select a resource. Use the search resource to search resources for ($business). <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=$execshowresourcebusiness&p1=biscuit&p2=business&p3=resourcekey&pnum=5&p4=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&jp=$jp&business=$business&resourcekey=$resname&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to go back. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=4&p0=$execmanageonebusiness&p1=biscuit&p2=business&p3=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&jp=$jp&business=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to manage business.");
      exit;
   }
   ...
   $resourcetype = $restab{$resname}{'type'};
   $resourcebldg = $restab{$resname}{'bldg'};
   $resourcezipcode = $restab{$resname}{'zipcode'};
   $resourcecountry = $restab{$resname}{'country'};
   $resourcetz =  $restab{$resname}{'tz'};
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/modifyresourcebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/modifyresourcebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=resourcename>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=resourcetype>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p5 VALUE=resourcebldg>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p6 VALUE=resourcecountry>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p7 VALUE=resourcezipcode>";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=resourcename VALUE=$resname>";
   ...
   $prml = strapp $prml, "resourcetype=$resourcetype";
   $prml = strapp $prml, "resourcename=$resname";
   $prml = strapp $prml, "resourcebldg=$resourcebldg";
   $prml = strapp $prml, "resourcezipcode=$resourcezipcode";
   $prml = strapp $prml, "resourcecountry=$resourcecountry";
   $prml = strapp $prml, "resourcetz=$resourcetz";
   $zonestr = getzonestr($resourcetz);
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/modifyresourcebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/modifyresourcebusiness-$$.html";
