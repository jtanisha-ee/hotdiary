...
# bind login table vars
  ...
  #    opendir THISDIR, "$ENV{HDDATA}/business/business/$business/directory"; 
  #    (@allfiles) = grep !/^\.\.?$/, readdir THISDIR;
  #    closedir THISDIR;
  # } else {
  #    status("$login: You donot have any contacts to view for ($business).");
  #    exit;
  # }
   ...
   if ($os ne "nt") {
      ...
      $execresellersdir = encurl "execresellersdir.cgi";
      ...
      $execresellersdir = "execresellersdir.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showbusinessdir.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showbusinessdir-$$.html";
   ...
   $prml = strapp $prml, "execcustomerdir=$execcustomerdir";
   $prml = strapp $prml, "execresellersdir=$execresellersdir";
   $prml = strapp $prml, "execmembersdir=$execmembersdir";
   $prml = strapp $prml, "execotherdir=$execotherdir";
   $prml = strapp $prml, "execteamsdir=$execteamsdir";
   $prml = strapp $prml, "execaddbusinesscontact=$execaddbusinesscontact";
   parseIt $prml;

   #system "cat $ENV{HDTMPL}/content.html";
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showbusinessdir.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showbusinessdir-$$.html";
