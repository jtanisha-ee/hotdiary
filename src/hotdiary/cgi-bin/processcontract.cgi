...
$prml = strapp $prml, "template=$ENV{HDTMPL}/processcontract.html";
$prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/processcontract-$$.html";

parseIt $prml;

#system "/bin/cat $ENV{HDTMPL}/content.html\n\n";
#system "/bin/cat $ENV{HDHREP}/$alphaindex/$login/processcontract.html";
hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/processcontract-$$.html";
