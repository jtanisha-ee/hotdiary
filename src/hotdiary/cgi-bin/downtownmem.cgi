...
# bind login table vars
   ...
   status("$login: Request to add your membership to $business for $25 per month has been sent to the business manager.");
  
   system "metasend -b -S 800000 -m \"text/html\" -s \"Add $login member to $business\" -e \"\" -t billing200\@hotdiary.com  -F noreply\@hotdiary.com"; 
