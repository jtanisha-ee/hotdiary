...
# Block the spammers!
      ...
      &flush(mhandle);
      system "/bin/mail -s \"Customer Query\" shobhaa.joshi\@gmail.com smitha\@redbasin.com manoj\@redbasin.com < $ENV{HDHOME}/tmp/contact_us$$";
      ...
      $cgis = adjusturl "http://www.shobhamusic.com";
