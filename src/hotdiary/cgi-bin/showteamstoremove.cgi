...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execremoveteams = encurl "execremoveteams.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prb = strapp $prb, "formenc=";
      $execremoveteams = "execremoveteams.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   }
   $prb = strapp $prb, "template=$ENV{HDTMPL}/showteamstoremove.html";
   $prb = strapp $prb, "templateout=$ENV{HDHREP}/$alphaindex/$login/showteamstoremove-$$.html";
   ...
   $hiddenvars = "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execremoveteams\">";
   ...
   $statmsg = "Business Managers & Business Master can create & remove teams.";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showteamstoremove.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showteamstoremove-$$.html";
