...
#
# FileName: othermemberui.cgi
# Purpose: othercalendar
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execothermembercal = encurl "execothermembercal.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execothermembercal = "execothermembercal.cgi";
   ...
   if ($jp ne "") {
      if (-f "$ENV{HDDATA}/$alphjp/$jp/templates/othercalendar.html") {
         $tmpl = "$ENV{HDDATA}/$alphjp/$jp/templates/othercalendar.html";
      } else {
         $tmpl = "$ENV{HDTMPL}/othercalendar.html";
      }
   } else {
      $tmpl = "$ENV{HDTMPL}/othercalendar.html";
   }
   ...
   #$prml = strapp $prml, "template=$ENV{HDTMPL}/othercalendar.html";

   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/othercalendar-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=$execothermembercal>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=memberid>";
   ...
   system "cat $ENV{HDHREP}/$alphaindex/$login/othercalendar-$$.html";
