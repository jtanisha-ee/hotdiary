...
# bind login table vars
   ...
   hddebug "business in sendbusinesspage = $business";
   $rh = $input{rh};
   if ($os ne "nt") {
...
# bind login table vars
  ...
  if ((time() - $sesstab{$biscuit}{'time'}) > $SESSION_TIMEOUT) {
   ...
   $successpage = "http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=4&p0=$execfile&p1=biscuit&p2=business&p3=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&business=$business&jp=$jp&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6";
