...
# parse the command line
   ...
   if ($action eq "Send") {
      ...
      &flush(mhandle);
      system "/bin/mail -s \"Investment Email ($name)\" manoj\@hotdiary.com < $ENV{HDHOME}/tmp/investin_hotdiary$$";
      status "Thank you for contacting HotDiary! Your message has been sent. We will get back to you as soon as possible.";
   }
