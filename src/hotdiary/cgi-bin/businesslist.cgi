...
#
# FileName: businesslist.cgi
# Purpose: Manage A Virtual Intranet
...
$diary = $ENV{DIARY};
   ...
   hddebug("businesslist.cgi example");
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      hddebug "execmanageonebusiness = $execmanageonebusiness";
   ...
   if ($os ne "nt") {
      $execbusinessmenu = encurl "execbusinessmenu.cgi";
   } else {
      $execbusinessmenu = "execbusinessmenu.cgi";
   }

   
   $prml = strapp $prml, "business=$sel";  
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/businesslist.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$login/businesslist-$$.html";

   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execbusinessmenu\">";
   ...
   #system "cat $ENV{HDHREP}/$login/businesslist.html";
   hdsystemcat "$ENV{HDHREP}/$login/businesslist-$$.html";
