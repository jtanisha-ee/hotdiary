...
#
# FileName: invitebynamebusiness.cgi
...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("invitebynamebusiness.cgi example");
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execshowinvitebymemberbusiness =  "execshowinvitememberbusiness.cgi";	
      $execproxylogout =  "/proxy/execproxylogout.cgi";
      $execdeploypage =  "execdeploypage.cgi";
      $execshowtopcal =  "execshowtopcal.cgi";
   }

   $prml = strapp $prml, "template=$ENV{HDTMPL}/invitebynamebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/invitebynamebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=searchbyname>";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/invitebynamebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/invitebynamebusiness-$$.html";
