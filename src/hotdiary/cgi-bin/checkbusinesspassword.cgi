...
#
# FileName: checkbusinesspassword.cgi
...
#session timeout in secs
   ...
   hddebug("checkbusinesspassword.cgi");
   ...
   SCHEMA => {
	...
	'account', 'topleft', 'topright', 'middleright', 'bottomleft', 
	'bottomright', 'meta'] };
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execverifybusinesspassword = encurl "execverifybusinesspassword.cgi";
      ...
      $execverifybusinesspassword = "execverifybusinesspassword.cgi";
      $execproxylogout =  "/proxy/execproxylogout.cgi";
      $execdeploypage =  "execdeploypage.cgi";
      $execshowtopcal =  "execshowtopcal.cgi";
   }
   $prml = strapp $prml, "template=$ENV{HDTMPL}/checkbusinesspassword.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$login/checkbusinesspassword-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execverifybusinesspassword\">";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=rpassword>";
   ...
   #system "cat $ENV{HDHREP}/$login/checkbusinesspassword.html";
   hdsystemcat "$ENV{HDHREP}/$login/checkbusinesspassword-$$.html";
