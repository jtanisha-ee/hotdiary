...
# bind login table vars
   ...
   if (($jp ne "") && (-f "$ENV{HDDATA}/$alphajp/$jp/templates/editnotes.html") ) {
      $tmpl = "$ENV{HDDATA}/$alphajp/$jp/templates/editnotes.html";
   } else {
      $tmpl = "$ENV{HDTMPL}/editnotes.html";
   }    
   ...
   $prml = strapp $prml, "label2=Add New Notes";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=desc>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=subject>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p5 VALUE=entry>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p6 VALUE=edit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p7 VALUE=g>";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=lwptemplate VALUE=$hddomain/rep/$alpha/$login/savenoteupload-$$.html>";
