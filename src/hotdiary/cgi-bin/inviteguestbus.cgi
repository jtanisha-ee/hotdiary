...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("inviteguestsbus.cgi example");
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execsendguestinvitation = encurl "execsendguestinvitation.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execsendguestinvitation = "execsendguestinvitation.cgi";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsendguestinvitation\">";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=business>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=invite>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=firstname>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p5 VALUE=lastname>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p6 VALUE=email>";
