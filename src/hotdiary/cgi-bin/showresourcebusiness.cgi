...
# Purpose: Show resources for an Business
...
#       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$res &nbsp;</FONT></TD>"; 
   ...
   if ($os ne "nt") {
      ...
      $execmodifyresourcebusiness = encurl "execmodifyresourcebusiness.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execmodifyresourcebusiness = "execmodifyresourcebusiness.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showresourcebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showresourcebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execmodifyresourcebusiness\">";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showresourcebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showresourcebusiness-$$.html";
