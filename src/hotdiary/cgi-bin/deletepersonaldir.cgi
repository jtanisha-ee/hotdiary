...
#
# FileName: deletepersonaldir.cgi
...
# bind login table vars
   ...
   $pcgi = adjusturl "/cgi-bin/$rh/execdogeneric.jsp?pnum=3&p0=$execpersonaldir&p1=biscuit&p2=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&jp=$jp&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&le5=HTTP_COOKIE&re5=HTTP_COOKIE&enum=6";
   ...
   $prml = strapp $prml, "templateout=$ENV{HDREP}/$alpha1/$login/dpc-$biscuit-$$.html";
