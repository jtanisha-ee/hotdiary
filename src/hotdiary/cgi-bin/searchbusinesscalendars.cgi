...
#
# FileName: searchbusinesscalendars.cgi
# Purpose: search by key word for calendars
...
#session timeout in secs
   ...
   hddebug ("searchbusinesscalendars.cgi");
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execshowbusinesscals = encurl "execshowbusinesscals.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execshowbusinesscals = "execshowbusinesscals.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/searchbusinesscalendars.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/searchbusinesscalendars-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execshowbusinesscals\">";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/searchbusinesscalendars.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/searchbusinesscalendars-$$.html";
