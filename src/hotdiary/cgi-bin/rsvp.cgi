...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execcompanyrsvp =  encurl "execcompanyrsvp.cgi";
   ...
   $prb = strapp $prb, "template=$ENV{HDTMPL}/rsvp.html";
   $prb = strapp $prb, "templateout=$ENV{HDHREP}/$login/rsvp.html";
   ...
   system "cat $ENV{HDHREP}/$login/rsvp.html";
