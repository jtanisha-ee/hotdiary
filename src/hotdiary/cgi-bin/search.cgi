...
# Block the spammers!
      ...
      &flush(mhandle);
      system "/bin/mail -s \"Customer Query ($name)\" rhsup\@hotdiary.com < $ENV{HDHOME}/tmp/contact_us$$";
      ...
      #system "java COM.hotdiary.main.SendPage \"1412165\" \"Customer $email $org\" \"$name\"";
   }
