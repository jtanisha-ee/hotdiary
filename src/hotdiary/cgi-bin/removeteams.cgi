...
# bind login table vars
   ...
   for ($i = $selbegin; $i <= $selend; $i= $i + 1) {
       $teamname = $input{"box$k"};
       #hddebug ("teamname = $teamname");
       $checkboxval = $input{$teamname};
       #hddebug "checkboxval = $checkboxval";

       if ($checkboxval eq "on") {
          if ($action eq "Delete Teams") {
             if ( ($teamname ne "") && ($business ne "") && ($ENV{HDDATA} ne "")) {
                if (exists($teamtab{$teamname})) {
                   delete($teamtab{$teamname});
                   hddebug "teamname = $teamname";
                   system "rm -f $ENV{HDDATA}/business/business/$business/teams/$teamname/busappttab/*.rec";
                   system "rm -f $ENV{HDDATA}/business/business/$business/teams/$teamname/bustodotab/*.rec";
                   system "rm -f $ENV{HDDATA}/business/business/$business/teams/$teamname/teampeopletab/*.rec";
                   system "rmdir  $ENV{HDDATA}/business/business/$business/teams/$teamname/busappttab";
                   system "rm -rf  $ENV{HDDATA}/business/business/$business/teams/$teamname/bustodotab";
                   system "rmdir  $ENV{HDDATA}/business/business/$business/teams/$teamname/teampeopletab";
                   system "rmdir  $ENV{HDDATA}/business/business/$business/teams/$teamname";
                }
             }
          }
       }
