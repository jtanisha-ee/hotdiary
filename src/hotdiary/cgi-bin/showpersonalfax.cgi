...
# bind login table vars
   ...
   if (exists $jivetab{$jp}) {
     ...
     $successpage = "Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=3&p0=$execfile&p1=biscuit&p2=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&jp=$jp&biscuit=$biscuit&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to go back.";
   ...
   if ( ($jp ne "") && (-f "$ENV{HDDATA}/$alphj/$jp/templates/showpersonalfax.html") ) {
      $template = "$ENV{HDDATA}/$alphj/$jp/templates/showpersonalfax.html";
   } else {
      $template = "$ENV{HDTMPL}/showpersonalfax.html";
   }   
   ...
   $prml = strapp $prml, "templateout=$ENV{HDREP}/$alphaindex/$login/showpersonalfax-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsendpersonalfax\">";
   ...
   #system "/bin/cat $ENV{HDREP}/$alphaindex/$login/showpersonalfax.html"; 
   hdsystemcat "$ENV{HDREP}/$alphaindex/$login/showpersonalfax-$$.html"; 
