...
# bind login table vars
   ...
   $cntr = 0;
   if ( ($login ne "manoj") && ($login ne "mjoshi") && ($login ne "smitha") ) {
	 ...
	 $cntr = $cntr + 1;
      ...
      #
      #	 $business = $downtowntab{$login}{business};
      #}
   }
   ...
   if ($os ne "nt") {
      ...
      $execaddbusiness = encurl "execaddbusiness.cgi";
      $execprocessaddbusiness = encurl "execprocessaddbusiness.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execaddbusiness = "execaddbusiness.cgi";
      $execprocessaddbusiness = "execprocessaddbusiness.cgi";
   ...
   $alpha = $alpha . '-index';
   $prml = strapp $prml, "template=$ENV{HDTMPL}/createbusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alpha/$login/createbusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execaddbusiness\">";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p5 VALUE=rpassword>";
   ...
   #system "cat $ENV{HDHREP}/$alpha/$login/createbusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alpha/$login/createbusiness-$$.html";
