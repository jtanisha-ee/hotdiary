...
# get the rate from a rate file in future.
     ...
     if ($balance <= 0) {
      ...
      ($afile = "$ENV{HDHOME}/tmp/att$$.txt") =~ s/\n/\n<BR>/g;
      open thandle, ">$afile";
     ...
     $successpage = "$login: ($ulogin) does not exist. Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=4&p0=$execfile&p1=biscuit&p2=business&p2=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&business=$business&jp=$jp&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to View Business Directory."; 
