...
#
# FileName: showteamgroupcals.cgi
...
# bind login table vars
 ...
 calendar.");  
   ...
   if ($cntr == 0) {
      ...
      status("$login: No matches were found with $teamname. If you have entered an empty string, it could be that business $business may not have any teams. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=$execcreatebusinesscalendar&p1=biscuit&p2=business&pnum=3&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&business=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to search. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=$execbusiness&p1=biscuit&p2=f&pnum=3&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&f=mc&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to go back to Business home page.");
      exit;
   }
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showteamgroupcals.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showteamgroupcals-$$.html";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showteamgroupcals.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showteamgroupcals-$$.html";
