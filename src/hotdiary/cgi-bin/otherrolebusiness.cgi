...
#
# FileName: otherrolebusiness.cgi
...
# bind login table vars
   ...
   if (exists $otheraccesstab{access}) {
      $invitepeople = $otheraccesstab{access}{access};
   } else { 
      $invitepeople = ""; 
   }
   ...
   if ($os ne "nt") {
      ...
      $execsaveotherrolebusiness = encurl "execsaveotherrolebusiness.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execsaveotherrolebusiness = "execsaveotherrolebusiness.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/otherrolebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/otherrolebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsaveotherrolebusiness\">";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/otherrolebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/otherrolebusiness-$$.html";
