...
# bind login table vars
  ...
  if (($biscuit ne "") && ($sc ne "p"))  {
   ...
   if ($f eq "j") {
      if (($login ne "buddie") || ($login ne "smitha") || ($login ne "manoj")) {
...
# Accessing hidden fields in form (hdcalviewtop.html)
      ...
      if ($a eq "a") {
         calfuncs::businesscalfuncs::addMeeting $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, "", "";
      }
      if ($a eq "e") {
         calfuncs::businesscalfuncs::updateMeeting $en, $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, "", "";
      }
   }
   ...
   if (($a ne "a") && ($a ne "e")) {
      ...
      businesscalutil::meetings::createCalendar($dy, $mo, $yr, "$ENV{HDHREP}/$repdir/businessmeet$rand$biscuit.html", $login, $biscuit, $vw, $f, $a, $h, $m, $tz, $en, $sc, $jvw, $teamname, $publish, "$rh", "$logo", "$title", "$banner", "$vdomain", "$hs", "$jp", "$os", "$business");
      #system "cat \"$ENV{HDHREP}/$repdir/businessmeet$rand$biscuit.html\"";
      hdsystemcat "$ENV{HDHREP}/$repdir/businessmeet$rand$biscuit.html";
   }
