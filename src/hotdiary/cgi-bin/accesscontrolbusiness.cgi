...
#
# FileName: accesscontrolbusiness.cgi
...
$diary = $ENV{DIARY};
   ...
   #print &PrintHeader;
   #print &HtmlTop ("accesscontrolbusiness.cgi example");
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execpasswordsettingbusiness = encurl "execpasswordsettingbusiness.cgi";
      $execchangepasswordbusiness = encurl "execchangepasswordbusiness.cgi";
      $execmanagerrolebusiness = encurl "execmanagerrolebusiness.cgi";
      $execotherrolebusiness =  encurl "execotherrolebusiness.cgi";
   } else {
      ...
      $execpasswordsettingbusiness = "execpasswordsettingbusiness.cgi";
      $execchangepasswordbusiness = "execchangepasswordbusiness.cgi";
      $execmanagerrolebusiness =  "execmanagerrolebusiness.cgi";
      $execotherrolebusiness =  "execotherrolebusiness.cgi";
   }
   $alph = substr $login, 0, 1;
   $alph = $alph . '-index';

   $prml = strapp $prml, "template=$ENV{HDTMPL}/accesscontrolbusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alph/$login/accesscontrolbusiness-$$.html";
   ...
   $prml = strapp $prml, "execpasswordsettingbusiness=$execpasswordsettingbusiness";
   $prml = strapp $prml, "execchangepasswordbusiness=$execchangepasswordbusiness";
   $prml = strapp $prml, "execmanagerrolebusiness=$execmanagerrolebusiness";
   $prml = strapp $prml, "execotherrolebusiness=$execotherrolebusiness";
   $prml = strapp $prml, "execmanageonebusiness=$execmanageonebusiness";
   $prml = strapp $prml, "jp=$jp";
   parseIt $prml;

   #system "cat $ENV{HDTMPL}/content.html";
   #system "cat $ENV{HDHREP}/$alph/$login/accesscontrolbusiness-$$.html";
   hdsystemcat "$ENV{HDHREP}/$alph/$login/accesscontrolbusiness-$$.html";
