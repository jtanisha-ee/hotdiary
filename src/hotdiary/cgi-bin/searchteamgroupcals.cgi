...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execshowteamgroupcals = encurl "execshowteamgroupcals.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execshowteamgroupcals = "execshowteamgroupcals.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/searchteamgroupcal.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/searchteamgroupcal-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execshowteamgroupcals\">";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/searchteamgroupcal.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/searchteamgroupcal-$$.html";
