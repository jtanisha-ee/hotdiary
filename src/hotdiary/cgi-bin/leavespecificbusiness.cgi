...
#
# FileName: leavespecificbusiness.cgi
...
#session timeout in secs
   ...
   hddebug("leavespecificbusiness.cgi example");
...
# bind login table vars
   ...
   if (exists($managertab{$login})) {
      delete $managertab{$login};
      tied(%managertab)->sync();
   }
 
   system "cat $ENV{HDTMPL}/content.html";
   if ($login ne "smitha") {
      system "cat $ENV{HDHREP}/$alphaindex/$login/business.html";
   } else {
      system "cat $ENV{HDHREP}/$alphaindex/$login/businessmenu.html";
   }
