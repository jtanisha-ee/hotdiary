...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("customerdir.cgi ");
   hddebug ("customerdir.cgi ");
...
# bind login table vars
   ...
   if (!(-d "$ENV{HDDATA}/business/business/$business/directory/customertab"))  {
      ...
      status ("$login: You currently do not have any contacts in the customers directory. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=3&p0=$execshowcontactlist&p1=biscuit&p2=businesslist&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&businesslist=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to return to business directory. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=$execaddbusinesscontact&p1=biscuit&p2=business&pnum=3&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&business=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to add a contact.");
      exit;
   }
   ...
   foreach $mem (sort keys %customertab) {
      $msg = "<TR>";
      ...
      $cdir .= " ";
          $cntr = $cntr + 1;
          hddebug "mem = $mem";
          $msg .= "<TD ALIGN=TOP><FONT FACE=\"Verdana\" SIZE=\"2\">$customertab{$mem}{'fname'}&nbsp;$customertab{$mem}{'lname'} &nbsp;</FONT></TD>";
          $email = $customertab{$mem}{email};
          $msg .= "<TD ALIGN=TOP><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"mailto:$email\">$email</a> &nbsp;</FONT></TD>";
          $msg .= "<TD ALIGN=TOP><FONT FACE=\"Verdana\" SIZE=\"2\">$customertab{$mem}{'bphone'}&nbsp;</FONT></TD>";
          $dbpagertype = $customertab{$mem}{pagertype};
          $dbpager = $customertab{$mem}{pager};
          $uname = $customertab{$mem}{fname}. " ". $customertab{$mem}{lname}; 
          ($dbfax = $customertab{$mem}{'fax'}) =~ s/\n/\n<BR>/g;
          $tostreet = replaceblanks $customertab{$mem}{street};
          $tocity = replaceblanks $customertab{$mem}{city};
          $tostate = replaceblanks $customertab{$mem}{state};
          ...
          $msg .= "<TD ALIGN=TOP><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"$directions\">Directions</a>&nbsp;</FONT></TD>";
          ...
          $faxurl = adjusturl("execdogeneric.cgi?pnum=7&p0=$execshowbusinessfax&p1=biscuit&p2=thispage&p3=to&p4=uname&p5=business&p6=dirtype&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&thispage=$thispage&to=$dbfax&uname=$uname&business=$business&dirtype=customerdir&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6"); 
          $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"http://$vdomain/cgi-bin/$rh/$faxurl\">$fax</a>&nbsp;</FONT></TD>";

          $contacttype = "Customers";
        
          if ($os ne "nt") {
             $execshowmorecontact = encurl "execshowmorecontact.cgi";
          } else {
             $execshowmorecontact = "execshowmorecontact.cgi";
          }
    
          $moreurl = adjusturl("execdogeneric.cgi?pnum=5&p0=$execshowmorecontact&p1=biscuit&p2=business&p3=entryno&p4=contacttype&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&entryno=$mem&contacttype=$contacttype&business=$business&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");
          $msg .= "<TD ALIGN=TOP><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"http://$vdomain/cgi-bin/$rh/$moreurl\">Edit</a>&nbsp;</FONT></TD>";
          $msg .= "</TR>";

          if (exists $customertab{$mem}) {
             $smsg .= $msg;
          } else {
             $umsg .= $msg;
          }
   ...
   foreach $cn (@hshcdir) {
      ...
      if ($os ne "nt") {
         ...
         $execcustomerdir = encurl "execcustomerdir.cgi"; 
         $execproxylogout = encurl "/proxy/execproxylogout.cgi";
         $execdeploypage =  encurl "execdeploypage.cgi";
         $execshowtopcal =  encurl "execshowtopcal.cgi";
      } else {
         $prb = strapp $prb, "formenc=";
         $execcustomerdir = "execcustomerdir.cgi"; 
         $execproxylogout =  "/proxy/execproxylogout.cgi";
         $execdeploypage =  "execdeploypage.cgi";
         $execshowtopcal =  "execshowtopcal.cgi";
      }

      $prb = strapp $prb, "template=$ENV{HDTMPL}/customerdir.html";
      $prb = strapp $prb, "templateout=$ENV{HDHREP}/$login/customerdir-$$.html";
      ...
      $hiddenvars = "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execcustomerdir\">";
	 ...
	 $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=box$k VALUE=$cn>";
      ...
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=re4 VALUE=HTTP_COOKIE>";
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=le4 VALUE=HTTP_COOKIE>";
      $hiddenvars = adjusturl $hiddenvars;
      $prb = strapp $prb, "hiddenvars=$hiddenvars";
      $prb = strapp $prb, "business=$business";
      $prb = strapp $prb, "bizdir=$smsg";
      $bizlabel = "$business - Customers Directory";
      ...
      #system "cat $ENV{HDHREP}/$login/customerdir.html";
      hdsystemcat "$ENV{HDHREP}/$login/customerdir-$$.html";
