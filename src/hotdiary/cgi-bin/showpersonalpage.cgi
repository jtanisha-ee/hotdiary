...
# bind login table vars
  ...
  $uname = $input{uname};
   ...
   if ($os ne "nt") {
      ...
      $execsendpersonalpage = encurl "execsendpersonalpage.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execsendpersonalpage = "execsendpersonalpage.cgi";
   ...
   if ( ($jp ne "") && 
      (-f "$ENV{HDDATA}/$alphj/$jp/templates/showpersonalpage.html")) {
      $template = "$ENV{HDDATA}/$alphj/$jp/templates/showpersonalpage.html";
   } else {
      $template = "$ENV{HDTMPL}/showpersonalpage.html";
   }    
   ...
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showpersonalpage-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsendpersonalpage\">";
   ...
   #system "/bin/cat $ENV{HDHREP}/$alphaindex/$login/showpersonalpage.html"; 
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showpersonalpage-$$.html"; 
