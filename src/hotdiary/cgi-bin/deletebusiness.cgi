...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execdeletespecificbusiness = encurl "execdeletespecificbusiness.cgi";
      ...
      $execdeletespecificbusiness = "execdeletespecificbusiness.cgi";
      $execproxylogout =  "/proxy/execproxylogout.cgi";
      $execdeploypage =  "execdeploypage.cgi";
      $execshowtopcal =  "execshowtopcal.cgi";
   }
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showtodeletebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$login/showtodeletebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execdeletespecificbusiness\">";
   ...
   #system "cat $ENV{HDHREP}/$login/showtodeletebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$login/showtodeletebusiness-$$.html";
