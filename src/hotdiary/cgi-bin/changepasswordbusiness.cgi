...
#
# FileName: changepasswordbusiness.cgi
# Purpose: Change Password for A Virtual Intranet
...
#session timeout in secs
   ...
   hddebug("changepasswordbusiness.cgi");
...
# bind login table vars
   ...
   if ($businesstab{$business}{businessmaster} ne $login) {
      status("$login: You do not have permission to change password for ($business) as you have to be business master.");
      exit; 
   }
   ...
   if ($os ne "nt") {
      ...
      $execsavepasswordbusiness = encurl "execsavepasswordbusiness.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execsavepasswordbusiness = "execsavepasswordbusiness.cgi";
      $execproxylogout =  "/proxy/execproxylogout.cgi";
      $execdeploypage =  "execdeploypage.cgi";
      $execshowtopcal =  "execshowtopcal.cgi";
   }
   $prml = strapp $prml, "template=$ENV{HDTMPL}/changepasswordbusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$login/changepasswordbusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsavepasswordbusiness\">";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=business>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=oldpassword>";
   ...
   #system "cat $ENV{HDHREP}/$login/changepasswordbusiness.html";
   hdsystemcat "$ENV{HDHREP}/$login/changepasswordbusiness-$$.html";
