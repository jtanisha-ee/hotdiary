...
#
# FileName: showresourcebusiness.cgi
# Purpose: Show resources for an Intranet
...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("showresourcebusiness.cgi example");
...
# bind login table vars
   ...
   $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Type</FONT></TD>";
   $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Building</FONT></TD>";
   $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Zipcode</FONT></TD>";
   $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Country</FONT></TD>";
   $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Time Zone</FONT></TD>";
   $msg .= "</TR>";
   $smsg = $msg;
   $umsg = $msg;
   $cntr = 0;
   ...
   $resnm = $input{'resourcekey'};
   $resnm = "\L$resnm";
   hddebug "resourcekey = $resnm";
   ...
   foreach $res (sort keys %restab) {
       if ($resnm ne "") {
          if ( ((index "\L$restab{$res}{'type'}", "\L$resnm") != -1) || 
            ((index "\L$restab{$res}{'name'}", "\L$resnm") != -1) ||
            ((index "\L$restab{$res}{'bldg'}", "\L$resnm") != -1) ||
            ((index "\L$restab{$res}{'zipcode'}", "\L$resnm") != -1) ||
            ((index "\L$restab{$res}{'country'}", "\L$resnm") != -1) ||
            ((index "\L$restab{$res}{'tz'}", "\L$resnm") != -1)  ) {
               $cntr = $cntr + 1; 
	 } 
      }
   }
   ...
   foreach $res (sort keys %restab) {
       ...
       $msg = "<TR>";
       $msg .= "<TD VALIGN=\"CENTER\"><FONT FACE=\"Verdana\" SIZE=\"2\"><INPUT TYPE=RADIO NAME=radio1 VALUE=\"$res\"></FONT></TD>";
#       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$res &nbsp;</FONT></TD>"; 
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$restab{$res}{'name'} &nbsp;</FONT></TD>";
       #$msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$res &nbsp;</FONT></TD>";
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$restab{$res}{'type'} &nbsp;</FONT></TD>";
        hddebug "showresource() building = $restab{$res}{bldg}";
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$restab{$res}{'bldg'} &nbsp;</FONT></TD>";
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$restab{$res}{'zipcode'} &nbsp;</FONT></TD>";
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$restab{$res}{'country'} &nbsp;</FONT></TD>";
       ($zonestr = getzonestr($restab{$res}{'tz'})) =~ s/\n/\n<BR>/g;  
       $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$zonestr &nbsp;</FONT></TD>";
       $msg .= "</TR>";

       if ((exists $restab{$res}) || (exists $restab{$res})) {
             $smsg .= $msg;
       } else {
             $umsg .= $msg;
       }
   ...
   if ($os ne "nt") {
      ...
      $execdeleteresourcebusiness = encurl "execdeleteresourcebusiness.cgi"; 
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
   } else {
      $prml = strapp $prml, "formenc=";
      $execdeleteresourcebusiness = "execdeleteresourcebusiness.cgi"; 
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showdelresourcebusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showdelresourcebusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execdeleteresourcebusiness\">";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=business>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=radio1>";
   ...
   $prml = strapp $prml, "resourcename=$resourcename";
   $smsg = adjusturl $smsg;
   $prml = strapp $prml, "resource=$smsg";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showdelresourcebusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showdelresourcebusiness-$$.html";
