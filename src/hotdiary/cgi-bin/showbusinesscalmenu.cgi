...
#
# FileName: showbusinesscal.cgi
# Purpose: show business calendar menu for search and create calendars
...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("showbusinesscal.cgi example");
...
# bind login table vars
   ...
   hddebug "showbusinesscalmenu = $execshowbusinesscalmenu";
   ...
   if (!exists $businesstab{$business}) {   
      status("$login: Business ($business) does not exist. Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=3&p0=$execcreatebusiness&p1=biscuit&p2=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to create business. <BR>Click <a href=\"http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?pnum=3&p0=$execbusiness&p1=biscuit&p2=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&jp=$jp&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6\">here</a> to return to business home."); 
      exit;        
   }
   ...
   if ($os ne "nt") {
      ...
      $execremovepeoplefromteam =  encurl "execremovepeoplefromteam.cgi";
      $execshowteamstoremove =  encurl "execshowteamstoremove.cgi";
      $execshowcontactconflict =  encurl "execshowcontactconflict.cgi";
      $execbusinessmeeting =  encurl "execbusinessmeeting.cgi";
      $execsearchteamgroupcals =  encurl "execsearchteamgroupcals.cgi";
      ...
      $execremovepeoplefromteam =  "execremovepeoplefromteam.cgi";
      $execshowteamstoremove =  "execshowteamstoremove.cgi";
      $execshowcontactconflict =  "execshowcontactconflict.cgi";
      $execbusinessmeeting =  "execbusinessmeeting.cgi";
      $execsearchteamgroupcals =  "execsearchteamgroupcals.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showbusinesscal.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/showbusinesscal-$$.html";
   ...
   #$hiddenvars = "<INPUT TYPE=HIDDEN NAME=pnum VALUE=2>";
   ...
   $prml = strapp $prml, "execremovepeoplefromteam=$execremovepeoplefromteam";
   $prml = strapp $prml, "execshowteams=$execshowteams";
   $prml = strapp $prml, "execshowteamstoremove=$execshowteamstoremove";
   $prml = strapp $prml, "execbusinessmeeting=$execbusinessmeeting";
   $prml = strapp $prml, "execsearchteamgroupcals=$execsearchteamgroupcals";
   $prml = strapp $prml, "execcompanycalclient=$execcompanycalclient";

   parseIt $prml;

   #system "cat $ENV{HDTMPL}/content.html";
   #system "cat $ENV{HDHREP}/$alphaindex/$login/showbusinesscal.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/showbusinesscal-$$.html";
