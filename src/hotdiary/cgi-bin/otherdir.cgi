...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("otherdir.cgi ");
   hddebug ("otherdir.cgi ");
...
# bind login table vars
   ...
   foreach $mem (sort keys %othertab) {
      $msg = "<TR>";
      $cdir .= $mem;
      $cdir .= " ";
          $cntr = $cntr +1;
          $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$othertab{$mem}{'fname'}&nbsp;$othertab{$mem}{'lname'} &nbsp;</FONT></TD>";
          $email = $othertab{$mem}{email};
          $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"mailto:$email\">$email</a> &nbsp;</FONT></TD>";
          $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$othertab{$mem}{'bphone'}&nbsp;</FONT></TD>";
          $dbpagertype = $othertab{$mem}{pagertype};
          $dbpager = $othertab{$mem}{pager};
          $uname = $othertab{$mem}{fname}. " ". $othertab{$mem}{lname}; 
          ($dbfax = $othertab{$mem}{'fax'}) =~ s/\n/\n<BR>/g;
          $tostreet = replaceblanks $othertab{$mem}{street};
          $tocity = replaceblanks $othertab{$mem}{city};
          $tostate = replaceblanks $othertab{$mem}{state};
   ...
   foreach $cn (@hshcdir) {
	 ...
	 $execotherdir = encurl "execotherdir.cgi";
	 ...
	 $execotherdir = "execotherdir.cgi";
         $execproxylogout =  "/proxy/execproxylogout.cgi";
         $execdeploypage =  "execdeploypage.cgi";
         $execshowtopcal =  "execshowtopcal.cgi";
      }

      $prb = strapp $prb, "template=$ENV{HDTMPL}/otherdir.html";
      $prb = strapp $prb, "templateout=$ENV{HDHREP}/$alphaindex/$login/otherdir.html";
      ...
      $hiddenvars = "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"execotherdir\">";
	 ...
	 $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=box$k VALUE=$cn>";
      ...
      $bizlabel = "$business - Other Contacts Directory";
      ...
      system "cat $ENV{HDHREP}/$alphaindex/$login/otherdir.html";
