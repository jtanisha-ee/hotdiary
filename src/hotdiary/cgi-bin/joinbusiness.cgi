...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execsearchtojoinbusiness = encurl "execsearchtojoinbusiness.cgi";
      $execproxylogout = encurl "/proxy/execproxylogout.cgi";
      $execdeploypage =  encurl "execdeploypage.cgi";
      $execshowtopcal =  encurl "execshowtopcal.cgi";
      
   } else {
      $execsearchtojoinbusiness = "execsearchtojoinbusiness.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/searchtojoinbusiness.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/searchtojoinbusiness-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsearchtojoinbusiness\">";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=businesstitle>";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/searchtojoinbusiness.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/searchtojoinbusiness-$$.html";
