...
#
# FileName: showmoreteams.cgi 
# Purpose: shows the details about contact information in teams
...
# bind login table vars
   ...
   if ($contacttype eq "Teams") {
      ...
      $teamtitle = $teamtab{$entryno}{teamtitle};

      $msg = "<TABLE BORDER=1 CELLPADDING=0 CELLSPACING=0 WIDTH=\"80%\">";
      $msg .= "<TR BGCOLOR=dddddd>";
      #$msg .= "<TD></TD>";
      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Team</FONT></TD>";
      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">People</FONT></TD>";
      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Settings</FONT></TD>";
      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">Add People</FONT></TD>";
      $msg .= "</TR>";
      $smsg = $msg;
      $umsg = $msg;

      tie %teampeopletab, 'AsciiDB::TagFile',
      DIRECTORY => "$ENV{HDDATA}/business/business/$business/teams/$entryno/teampeopletab",
      SUFIX => '.rec',
      SCHEMA => {
         ORDER => ['login']};

      $msg = "<TR>";
      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$teamtab{$entryno}{teamname} &nbsp;</FONT></TD>";
      hddebug "entryno = $entryno";
     
      $editurl = adjusturl("execdogeneric.cgi?pnum=4&p0=$execeditteamsettings&p1=biscuit&p2=business&p3=teamname&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&teamname=$entryno&business=$business&rh=$rh&vdomain=$vdomain&hs=$hs&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");

      foreach $mem (sort keys %teampeopletab) {
         $people .= "$logtab{$mem}{fname} $logtab{$mem}{lname} - ($mem}<BR>"; 
      }

      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\">$people &nbsp;</FONT></TD>";

      $addpeople = adjusturl ("execdogeneric.cgi?p0=$execshowpeopletoteam&p1=biscuit&p2=business&pnum=3&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&biscuit=$biscuit&business=$business&rh=$rh&hs=$hs&vdomain=$vdomain&le4=os&re4=os&re5=HTTP_COOKIE&le5=HTTP_COOKIE&enum=6");

      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"http://$vdomain/cgi-bin/$rh/$editurl\">Settings</a>&nbsp;</FONT></TD>";

      $msg .= "<TD><FONT FACE=\"Verdana\" SIZE=\"2\"><a href=\"http://$vdomain/cgi-bin/$rh/$addpeople\">Add People</a>&nbsp;</FONT></TD>";

      $msg .= "</TR>";
      if (exists ($teamtab{$entryno}) ) {
         $smsg .= $msg;
      } else {
         $umsg .= $msg;
      }
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/showmoreteams.html";
   $prml = strapp $prml, "templateout=$ENV{HDREP}/$alphaindex/$login/showmoreteams-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execshowmoreteams\">";
   ...
   $prml = strapp $prml, "bizdir=$smsg";
   $bizlabel = "$business - Teams Rolodex";
   $prml = strapp $prml, "bizlabel=$bizlabel";
   ...
   #system "/bin/cat $ENV{HDREP}/$alphaindex/$login/showmoreteams.html"; 
   hdsystemcat "$ENV{HDREP}/$alphaindex/$login/showmoreteams-$$.html"; 
