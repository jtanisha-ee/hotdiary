...
#
# FileName: inviteguest.cgi
# Purpose: send an invitation to guest
# Calls: execsendinvitation.cgi
...
#session timeout in secs
   ...
   #print &PrintHeader;
   #print &HtmlTop ("inviteguest.cgi example");
   hddebug "inviteguest.cgi()";
...
# bind login table vars
   ...
   if ($os ne "nt") {
      ...
      $execsendinvitation = encurl "execsendinvitation.cgi";
      ...
      $execsendinvitation =  "execsendinvitation.cgi";
   ...
   $prml = strapp $prml, "template=$ENV{HDTMPL}/inviteguestbus.html";
   $prml = strapp $prml, "templateout=$ENV{HDHREP}/$alphaindex/$login/inviteguestbus-$$.html";
   ...
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execsendinvitation\">";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p1 VALUE=biscuit>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p2 VALUE=invite>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p3 VALUE=firstname>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=lastname>";
   $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p5 VALUE=email>";
   ...
   #system "cat $ENV{HDHREP}/$alphaindex/$login/inviteguestbus.html";
   hdsystemcat "$ENV{HDHREP}/$alphaindex/$login/inviteguestbus-$$.html";
