...
#
# FileName: saveotherrolebusiness.cgi
...
#session timeout in secs
   ...
   hddebug("saveotherrolebusiness.cgi");
...
# bind login table vars
   ...
   #other access in company directory
   ...
   if ($input{'invitepeople'} eq "on") {
      $otheraccesstab{access}{'access'} = "CHECKED";
   }  else {
      $otheraccesstab{access}{'access'} = $input{'invitepeople'};
   }
