...
#
# FileName: businesscalclient.cgi
...
# reset the timer.
   ...
   if (($sc ne "p") && ($a eq "u")) {
      calfuncs::businesscalfuncs::addBusEventToMyCal($en, $login, $business, $teamname);
      $a = "d";
   }
   ...
   if ($f eq "h") {
      ...
      #}
      $pr = "";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/d$biscuit.html";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/diarymenu.html";
      $pr = strapp $pr, "leftFrame=rep/$alph/$login/l$biscuit.html";
      $pr = strapp $pr, "rightFrame=rep/$alph/$login/$biscuit.html";
      ...
      $pr = strapp $pr, "templateout=$ENV{HDREP}/$alph/$login/l$biscuit.html";
      $pr = strapp $pr, "biscuit=$biscuit";
      ...
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/stdpghdr.html";
      $pr = strapp $pr, "expiry=";
      parseIt $pr;
      ...
      $pr = strapp $pr, "label=$label";
      $pr = strapp $pr, "biscuit=$biscuit";
      $buddy = "rep/$alph/$login/friend$biscuit.html";
      $pr = strapp $pr, "buddy=$buddy";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/friend.html";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/friend.html";
      $buddy = "rep/$alph/$login/friend$biscuit.html";
      $pr = strapp $pr, "buddy=$buddy";
      parseIt $pr;
      system "/bin/cat $ENV{HDHREP}/$alph/$login/friend.html > $ENV{HDREP}/$alph/$login/friend$biscuit.html";
      $pr = "";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/addrmenutblhdr.html";
      $pr = strapp $pr, "actioncgi=cgi-bin/execaddraddsearch.cgi";
      $pr = strapp $pr, "biscuit=$biscuit";
      $pr = strapp $pr, "buddy=$buddy";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/addrmenutblhdr.html";
      parseIt $pr;

      $pr = "";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/menuaddrtbl.html";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/menuaddrtbl.html";
      parseIt $pr;

      $pr = "";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/stdmenutblftr.html";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/stdmenutblftr.html";   
      parseIt $pr;

      $pr = "";
      $pr = strapp $pr, "template=$ENV{HDTMPL}/stdpgftr.html";
      $pr = strapp $pr, "templateout=$ENV{HDHREP}/$alph/$login/stdpgftr.html";
      parseIt $pr;

      system "/bin/cat $ENV{HDHREP}/$alph/$login/stdpghdr.html $ENV{HDHREP}/$alph/$login/addrmenutblhdr.html $ENV{HDHREP}/$alph/$login/menuaddrtbl.html $ENV{HDHREP}/$alph/$login/stdmenutblftr.html $ENV{HDHREP}/$alph/$login/stdpgftr.html > $ENV{HDREP}/$alph/$login/$biscuit.html";

      system "/bin/cat $ENV{HDHREP}/$alph/$login/d$biscuit.html";
      exit;
   }
...
# Accessing hidden fields in form (hdcalviewtop.html)
      ...
      $evtbanner = adjusturl $evtbanner;

      if ($f eq "e") {
         hddebug "pc = $pc";
         if ($a eq "a") {
            addEvent $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, $pc, $evtbanner;
         }
         if ($a eq "e") {
            updateEvent $en, $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, $pc, $evtbanner;
         }
         #system "cat $rurl";
         hdsystemcat "$rurl";
      } else {
         # this is for confirmation and id last two parameters for meetings
         if ($a eq "a") {
            addMeeting $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, "", "", $evtbanner;
         }
         if ($a eq "e") {
            hddebug "eday = $eday, eyear=$eyear";
            updateMeeting $en, $etitle, $edtype, $edesc, $emonth, $eday, $eyear, $erecurtype, $ehour, $emin, $emeridian, $ezone, $eshare, $efree, $eatype, $edhour, $edmin, $login, $business, $econtact, $teamname, "", "", $evtbanner;
	 }
      }
   }
...
# Accessing hidden fields in form (hdcalviewtop.html)
      ...
      #status("rurl = $rurl");
      if ($a eq "a") {
         addTodo $etitle, $edesc, $emonth, $eday, $eyear, $ehour, $emeridian, $eshare, $epriority, $estatus, $login, $business, $teamname, $pc, $evtbanner;
      }
      if ($a eq "e") {
         updateTodo $en, $etitle, $edesc, $emonth, $eday, $eyear, $ehour, $emeridian, $eshare, $epriority, $estatus, $login, $business, $teamname, $pc, $evtbanner;
      }
      #system "cat $rurl";
      hdsystemcat "$rurl";
   ...
   if (($a ne "a") && ($a ne "e")) {
      ...
      # else {
      #   $publish = $teamtab{$login}{calpublish};
      #}

      hddebug "called createcalendar"; 
      businesscalutil::businesscalutil::createCalendar($dy, $mo, $yr, "$ENV{HDHREP}/$repdir/businesscal$rand$biscuit.html", $login, $biscuit, $vw, $f, $a, $h, $m, $tz, $en, $sc, $jvw, $teamname, $publish, "$rh", "$logo", "$title", "$banner", "$vdomain", "$hs", "$jp", "$os", "$business", $partner);
      #system "cat \"$ENV{HDHREP}/$repdir/businesscal$rand$biscuit.html\"";
      hdsystemcat "$ENV{HDHREP}/$repdir/businesscal$rand$biscuit.html";
   }
