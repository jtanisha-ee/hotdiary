...
# this is redirect url, will be invoked when Save button is pressed
      ...
      $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p4 VALUE=numend>";
...
# Initialize Functions
   ...
   if ( ($login ne "") && ($sc ne "p") && (-f "$ENV{HDREP}/$alphaindex/$login/topcal.html") ) {
      $fref = adjusturl "http://$vdomain/cgi-bin/$rh/execdogeneric.cgi?p0=ZXhlY3Nob3d0b3BjYWwuY2dp&p1=biscuit&pnum=3&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&le4=os&re4=os&biscuit=$biscuit&enum=5";
   } else {
