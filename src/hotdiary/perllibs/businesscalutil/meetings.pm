package businesscalutil::meetings;
require Exporter;
use Time::Local;
use tparser::tparser;
use utils::utils;
...
sub createCalendar {
   my($dy, $mo, $yr, $dp, $login, $biscuit, $vw, $f, $a, $h, $m, $tz, $en, $sc, $jvw, $teamname, $calp, $rh, $logo, $title, $banner, $vdomain, $hs, $jp, $os, $business) = @_;
   ...
   if (( $a eq "de") || ($a eq "da")) {
     ...
     $hiddenvars = "<INPUT TYPE=HIDDEN NAME=p0 VALUE=\"$execbusinessmeeting\">";
   }
...
# Init the base CGI url
   ...
   if ($biscuit eq "") {
       ...
       $cgiscript = "execdogeneric.cgi?pnum=12&p0=$execbusinessmeeting&p1=sc&p2=l&p3=teamname&p4=business&p5=mo&p6=dy&p7=yr&p8=vw&p9=f&p10=a&p11=jp&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
       #$cgiscript = adjusturl "execbusinessmeeting.cgi?sc=$sc&l=$login&g=$g&jp=$jp";
      
   } else {
       $dpms = "biscuit=$biscuit&teamname=$teamname&jp=$jp&business=$business";
       $cgiscript = "execdogeneric.cgi?pnum=13&p0=$execbusinessmeeting&p1=biscuit&p2=teamname&p3=business&p4=mo&p5=dy&p6=yr&p7=vw&p8=f&p9=a&p10=jp&p11=jvw&p12=en&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
       #$cgiscript = adjusturl "execbusinessmeeting.cgi?biscuit=$biscuit&g=$g&jp=$jp";
...
# Init the page header
   ...
   $label2 = "Use Events, To-Dos, and Meetings ";
...
# Init master template vars
   ...
   $caltop = "$ENV{HDTMPL}/hdmeetingviewtop.html";
   $calbot = "$ENV{HDTMPL}/hdmeetingviewbottom.html";
   $caldaily = "$ENV{HDTMPL}/hdmeetingdailyview.html";
   $calyearly = "$ENV{HDTMPL}/hdmeetingyearlyview.html";
   $calmonthly = "$ENV{HDTMPL}/hdmeetingmonthlyview.html";
   $calweekly = "$ENV{HDTMPL}/hdmeetingweeklyview.html";
   $calmeeting = "$ENV{HDTMPL}/hdbusinesscalmeetingview.html";
...
# this is redirect url, will be invoked when Save button is pressed
      ...
      if ($a eq "de") {
         ...
         $hiddenvars .= "<INPUT TYPE=HIDDEN NAME=p41 VALUE=timedur>";
         $hiddenpnum = 42;
      }

      if ($biscuit eq "") {
         $rscript = "execdogeneric.cgi?pnum=13&p0=$execbusinessmeeting&p1=sc&p2=l&p3=teamname&p4=business&p5=mo&p6=dy&p7=yr&p8=vw&p9=f&p10=a&p11=jp&p12=jvw&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
      } else {
         $rscript = "execdogeneric.cgi?pnum=12&p0=$execbusinessmeeting&p1=biscuit&p2=teamname&p3=business&p4=mo&p5=dy&p6=yr&p7=vw&p8=f&p9=a&p10=jp&p11=jvw&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
      }
...
# Initialize Functions
   ...
   $prml = strapp $prml, "home=$fref"; 
      ...
      #if ($f eq "e") 
         #$repht = adjusturl "<a href=\"$cgis&mo=$mo&dy=$dy&yr=$yr&vw=$vew&f=r&a=d\"><FONT FACE=\"Verdana\" SIZE=\"5\">Report</FONT></a><BR><BR>";
...
# Init the day label
      ...
      $tpartial = "$hdhrep/hdmeetingdailyview-$biscuit.html";
      ...
      if (($f eq "e") || ($f eq "t") || ($f eq "m")) {
         ...
         for ($i = 0; $i <= 18; $i++) {
            ...
            if ($biscuit eq "") {
                $tscript = "execdogeneric.cgi?pnum=14&p0=$execbusinessmeeting&p1=sc&p2=l&p3=teamname&p4=business&p5=mo&p6=dy&p7=yr&p8=vw&p9=f&p10=a&p11=jp&p12=h&p13=m&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
            } else {
                $tscript = "execdogeneric.cgi?pnum=13&p0=$execbusinessmeeting&p1=biscuit&p2=teamname&p3=business&p4=mo&p5=dy&p6=yr&p7=vw&p8=f&p9=a&p10=jp&p11=h&p12=m&re0=CGISUBDIR&le0=rh&re1=HTTPSUBDIR&le1=hs&re2=SERVER_NAME&le2=vdomain&re3=HDLIC&le3=HDLIC&HDLIC=$HDLIC&$dpms&le4=os&re4=os&enum=5";
            }
...
# new item view
   if (($vw eq "n") || ($vw eq "i")) {
      ...
      if ($a eq "da") {
         $tpartial = "$hdhrep/hdbusinesscalmeetingview.html";
         qx{cat $caltop $calmeeting $calbot > $tpartial};
	 $members = calfuncs::businesscalfuncs::getmembers($login);
         $groups = calfuncs::businesscalfuncs::getgroups($login); 
         $resources = calfuncs::businesscalfuncs::getresources($login, $business); 
         $bizmembers = calfuncs::businesscalfuncs::getbusinessdir($business, $login);

         $teams = calfuncs::businesscalfuncs::getteams($login, $business); 
         $prml = strapp $prml, "template=$tpartial";
         ...
         $prml = strapp $prml, "pmembers=$members";
         $bizmembers = adjusturl($bizmembers);
         $prml = strapp $prml, "bizmembers=$bizmembers";
         $groups = trim($groups);
         $prml = strapp $prml, "pgroups=$groups";
         $prml = strapp $prml, "pteams=$teams";
         $prml = strapp $prml, "presources=$resources";
         $prml = strapp $prml, "chour=0";
         $prml = strapp $prml, "cday=0";
         $prml = strapp $prml, "cweek=0";
         $prml = strapp $prml, "cmonth=0";
         if ($os ne "nt") {
...
# monthly view
   if ($vw eq "m") {
      ...
      $tpartial = "$hdhrep/hdmeetingmonthlyview-$biscuit.html";
...
# yearly view
   if ($vw eq "y") {
      if (($yr >= 1996) && ($yr <= 2008)) {
         $tpartial = "$hdhrep/hdmeetingyearlyview-$biscuit.html";
...
########
         ...
         $prml = strapp $prml, "year=$yr"; 
         #$prml = strapp $prml, "template=$ENV{HDTMPL}/hdmeetingyearlyview.html"; 
      }
   }
...
# weekly view
   if ($vw eq "w") {
      ...
      $tpartial = "$hdhrep/hdmeetingweeklyview-$biscuit.html";
