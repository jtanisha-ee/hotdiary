...
sub parseIt {
 ...
 # }
  ...
  while (<infiile>) {
     ...
     $eline = replaceit $eline, '\$ppgroups', $arglist{'ppgroups'}; 
     ...
     $eline = replaceit $eline, '\$pcalendarprog', $arglist{'pcalendarprog'}; 
     ...
     $eline = replaceit $eline, '\$calclient', $arglist{'calclient'};
     $eline = replaceit $eline, '\$calpublish', $arglist{'calpublish'};
     $eline = replaceit $eline, '\$formenc', $arglist{'formenc'};
     $eline = replaceit $eline, '\$calinvite', $arglist{'calinvite'};
