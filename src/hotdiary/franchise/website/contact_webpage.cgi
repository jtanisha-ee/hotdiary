...
if ($g ne "") {
   ...
   #hddebug "leditgrouptab publicedit = $leditgrouptab{$g}{'publicedit'}";
   #if (exists $leditgrouptab{$g}) {
   #   if (($leditgrouptab{$g}{'publicedit'} ne "CHECKED") && ($lgrouptab{$g}{'password'} ne "")) {
   #      hddebug "came here";
   #      statuss("The group master for this secure addressbook or contact manager, \"$g\",  has decided not to allow public editing of this addressbook or contact manager.");
   #      exit;
   #   }
