...
$hs = $ENV{HTTPSUBDIR};
system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/proxy/execproxywebpage.cgi?sc=p&l=$login&login=$login&rh=$rh&HDLIC=$HDLIC&g=$g&vdomain=$vdomain&hs=$hs\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\" \"68.127.24.45\"";
