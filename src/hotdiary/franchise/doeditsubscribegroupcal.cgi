...
system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/execeditsubscribegroupcal.cgi?biscuit=$biscuit&radio1=$radio1&rh=$rh&edit=$edit&unsubscribe=$unsubscribe&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\" \"$ip\"";
