package COM.hotdiary.eventfeed.isp.server;
import java.rmi.*;
...
public class ISPFeedServerImpl extends UnicastRemoteObject implements EFServer {
 ...
 public void feedEvent(String title, String desc) throws java.rmi.RemoteException {
    ...
    public ISPFeedServerImpl() throws java.rmi.RemoteException {
       super();
    }
    ...
    public static void main(String args[])
    {
        ...
        try {
            EFServer obj = new ISPFeedServerImpl();
            Naming.rebind("ISPFeedServer", obj);
            System.out.println("ISPFeedServerImpl created and bound in the registry to the name ISPFeedServer");
        } catch (Exception e) {
            System.out.println("ISPFeedServerImpl.main: an exception occurred:");
            e.printStackTrace();
        }
    }
