...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/proxy/execproxylogin.cgi?password=$password&login=$login&rh=$rh&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
