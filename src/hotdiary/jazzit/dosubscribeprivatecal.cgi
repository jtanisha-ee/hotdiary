...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/execsubscribeprivatecal.cgi?biscuit=$biscuit&rh=$rh&password=$password&g=$g&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
