...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/proxy/execproxyprofile.cgi?password=$password&login=$login&action=$action&rh=$rh&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
