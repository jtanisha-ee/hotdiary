...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/execgroupcal.cgi?biscuit=$biscuit&f=$f&rh=$rh&status=$status&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
