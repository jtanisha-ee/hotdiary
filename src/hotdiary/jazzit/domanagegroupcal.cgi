...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/execmanagegroupcal.cgi?biscuit=$biscuit&f=$f&rh=$rh&delete=$delete&pgroups=$pgroups&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
