...
#system "java COM.hotdiary.franchise.FetchCal \"/cgi-bin/execsearchgroupcal.cgi?biscuit=$biscuit&rh=$rh&calkey=$calkey&HDLIC=$HDLIC&vdomain=$vdomain&hs=$hs&jp=$jp\" \"$firewall\" \"$proxyPort\" \"$proxyHost\" \"$proxySet\"";
